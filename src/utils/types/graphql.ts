...
export function useGetTeamsQuery(
  ...
  return Urql.useQuery<GetTeamsQuery, GetTeamsQueryVariables>({
...
export function useGetTasksQuery(
  options: Omit<Urql.UseQueryArgs<GetTasksQueryVariables>, "query">,
) {
  return Urql.useQuery<GetTasksQuery, GetTasksQueryVariables>({
